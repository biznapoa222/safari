...
@section('content')
<x-admin.top-bar title="Create Itinerary Template" description="Itinerary Templates" :search="false" :addButton="false">
    <a href="{{ route('admin.itinerary-templates.index') }}" class="button button-ghost"><i data-lucide="arrow-left"></i> Back to Templates</a>
</x-admin.top-bar>

@include('admin.partials.flash')

<form method="POST" action="{{ route('admin.itinerary-templates.store') }}" style="display:grid;grid-template-columns:2fr 1fr;gap:16px;align-items:start">
    @csrf
        ...
        <section class="ops-panel">
            ...
            <div style="padding:16px;display:grid;grid-template-columns:1fr 1fr;gap:12px">
                <div style="grid-column:1/-1">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}" style="width:100%;height:38px;padding:0 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'">
                </div>
                <div style="grid-column:1/-1">
                    <label style="display:block;font-size:9px;font-weight:600;color:var(--text-muted);margin-bottom:6px">Trip Name</label>
                    <input type="text" name="trip_name" value="{{ old('trip_name') }}" style="width:100%;height:38px;padding:0 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'">
                </div>
                <div>
                    ...
                    <select name="destination_id" style="width:100%;height:38px;padding:0 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'">
                        ...
                        <option value="{{ $country->id }}" @selected(old('destination_id') == $country->id)>{{ $country->country }}</option>
                        @endforeach
                    </select>
                </div>
                <div>
                    <label style="display:block;font-size:9px;font-weight:600;color:var(--text-muted);margin-bottom:6px">Duration (Days) *</label>
                    <input type="number" name="duration_days" id="durationDays" value="{{ old('duration_days', 1) }}" min="1" max="99" style="width:100%;height:38px;padding:0 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'">
                </div>
                <div>
        ...
        <section class="ops-panel">
            ...
            <div style="padding:16px;display:flex;flex-direction:column;gap:12px">
                <div>
                    ...
                    <textarea name="overview" rows="4" style="width:100%;padding:9px 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none;resize:vertical" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'">{{ old('overview') }}</textarea>
                </div>
                <div>
                    <label style="display:block;font-size:9px;font-weight:600;color:var(--text-muted);margin-bottom:6px">Highlights</label>
                    <textarea name="highlights" rows="3" style="width:100%;padding:9px 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none;resize:vertical" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'">{{ old('highlights') }}</textarea>
                </div>
                <div>
                    <label style="display:block;font-size:9px;font-weight:600;color:var(--text-muted);margin-bottom:6px">Includes</label>
                    <textarea name="includes" rows="3" style="width:100%;padding:9px 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none;resize:vertical" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'">{{ old('includes') }}</textarea>
                </div>
                <div>
                    <label style="display:block;font-size:9px;font-weight:600;color:var(--text-muted);margin-bottom:6px">Excludes</label>
                    <textarea name="excludes" rows="3" style="width:100%;padding:9px 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none;resize:vertical" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'">{{ old('excludes') }}</textarea>
                </div>
            </div>
        </section>
        ...
        <section class="ops-panel">
            ...
            <div style="padding:16px;display:flex;flex-direction:column;gap:12px">
                <div>
                    ...
                    <textarea name="terms" rows="3" style="width:100%;padding:9px 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none;resize:vertical" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'">{{ old('terms') }}</textarea>
                </div>
                <div>
                    <label style="display:block;font-size:9px;font-weight:600;color:var(--text-muted);margin-bottom:6px">Booking Terms</label>
                    <textarea name="booking_terms" rows="3" style="width:100%;padding:9px 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none;resize:vertical" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'">{{ old('booking_terms') }}</textarea>
                </div>
                <div>
                    <label style="display:block;font-size:9px;font-weight:600;color:var(--text-muted);margin-bottom:6px">Payment Schedule</label>
                    <textarea name="payment_schedule" rows="3" style="width:100%;padding:9px 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none;resize:vertical" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'">{{ old('payment_schedule') }}</textarea>
                </div>
                <div>
                    <label style="display:block;font-size:9px;font-weight:600;color:var(--text-muted);margin-bottom:6px">Cancellation Policy</label>
                    <textarea name="cancellation_policy" rows="3" style="width:100%;padding:9px 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none;resize:vertical" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'">{{ old('cancellation_policy') }}</textarea>
                </div>
                <div>
                    <label style="display:block;font-size:9px;font-weight:600;color:var(--text-muted);margin-bottom:6px">Refund Policy</label>
                    <textarea name="refund_policy" rows="3" style="width:100%;padding:9px 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none;resize:vertical" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'">{{ old('refund_policy') }}</textarea>
                </div>
                <div>
                    <label style="display:block;font-size:9px;font-weight:600;color:var(--text-muted);margin-bottom:6px">Important Notes</label>
                    <textarea name="important_notes" rows="3" style="width:100%;padding:9px 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none;resize:vertical" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'">{{ old('important_notes') }}</textarea>
                </div>
            </div>
        </section>
    ...
    <div style="display:flex;flex-direction:column;gap:16px">
        <section class="ops-panel" style="position:sticky;top:96px">
            ...
            <div style="padding:16px;display:flex;flex-direction:column;gap:10px">
                ...
                <a href="{{ route('admin.itinerary-templates.index') }}" style="display:block;text-align:center;color:var(--text-muted);font-size:9px;padding:8px 0;text-decoration:none">Cancel</a>
            </div>
        </section>
    </div>
</form>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var dayIndex = {{ old('days') ? count(old('days')) : 0 }};
    var oldDays = {};
