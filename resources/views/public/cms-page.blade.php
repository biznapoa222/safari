...
@section('content')
<x-public.page-hero :label="$post->type === 'destination' ? 'Destination Guide' : 'Shishi Footsteps'" :title="$post->title" :subtitle="$post->seo_description" :image="$post->cover_image ?: 'https://images.unsplash.com/photo-1489392191049-fc10c97e64b6?auto=format&fit=crop&w=1800&q=82&fm=webp'" />
