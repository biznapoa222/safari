<div class="visitor-chat" data-visitor-chat data-start-url="{{ route('chat.start') }}" data-base-url="{{ url('/chat') }}">
    <div class="chat-invite" data-chat-invite>
        <button class="visitor-chat-button" type="button" aria-label="Chat with Shishi Footsteps">
            <span class="chat-mascot" aria-hidden="true"><img src="{{ asset('images/brand/shishi-paw-white.png') }}" alt=""></span>
