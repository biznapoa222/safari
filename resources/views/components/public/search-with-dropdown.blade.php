@props(['placeholder' => 'Search itineraries...', 'endpoint' => route('public.search.itineraries'), 'showAllOnFocus' => true, 'extra' => '', 'name' => 'q'])

<div class="search-dropdown" data-endpoint="{{ $endpoint }}" data-show-all="{{ $showAllOnFocus ? '1' : '0' }}">
