...
<section class="destination-section-page">
    <aside class="destination-section-menu">
        ...
        <?php endif; ?>
        <a href="<?php echo e(route('public.blog', ['destination' => $name])); ?>">All journal stories</a>
    </aside>
...
<?php endif; ?>
        ...
        <div class="destination-section-actions">
            ...
            <?php if($section === 'journal'): ?>
                <a href="<?php echo e(route('public.blog', ['destination' => $name])); ?>" class="button hero-secondary">Browse the full journal<i data-lucide="book-open"></i></a>
            <?php endif; ?>
            <?php if($section === 'reviews'): ?>
                <a href="<?php echo e(route('public.booking', ['destination' => $name])); ?>" class="button hero-secondary">Request a proposal<i data-lucide="pen-line"></i></a>
            <?php endif; ?>
        </div>
    </article>
</section>

<?php if($section === 'reviews' && ($travellerReviews ?? [])): ?>
    <section class="traveller-reviews-band" id="reviews">
        <div class="section-heading">
            <div>
                <?php if (isset($component)) { $__componentOriginalef375b1d2be2fadf1abf4fd72c1d16c4 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalef375b1d2be2fadf1abf4fd72c1d16c4 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.public.section-label','data' => ['label' => 'Guest notes']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('public.section-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Guest notes']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalef375b1d2be2fadf1abf4fd72c1d16c4)): ?>
<?php $attributes = $__attributesOriginalef375b1d2be2fadf1abf4fd72c1d16c4; ?>
...
<?php unset($__componentOriginalef375b1d2be2fadf1abf4fd72c1d16c4); ?>
<?php endif; ?>
                <h2><?php echo e($name); ?> in their words</h2>
            </div>
        </div>
        <div class="traveller-reviews">
            <?php $__currentLoopData = $travellerReviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <article class="traveller-review<?php echo e($loop->even ? ' traveller-review--end' : ''); ?>">
                    <img src="<?php echo e(\App\Support\MediaPath::publicUrl($review['image'])); ?>" alt="<?php echo e($review['image_alt'] ?? $review['trip']); ?>" loading="lazy">
                    <div>
                        <blockquote><?php echo e($review['quote']); ?></blockquote>
                        <p>
                            <strong><?php echo e($review['name']); ?></strong>
                            <span><?php echo e($review['from']); ?> · <?php echo e($review['trip']); ?></span>
                        </p>
                    </div>
                </article>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php if($section !== 'reviews' && ($journalPosts ?? collect())->isNotEmpty()): ?>
    <section class="content-band destination-related">
        <div class="section-heading">
            <div>
                <?php if (isset($component)) { $__componentOriginalef375b1d2be2fadf1abf4fd72c1d16c4 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalef375b1d2be2fadf1abf4fd72c1d16c4 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.public.section-label','data' => ['label' => 'The journal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('public.section-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'The journal']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalef375b1d2be2fadf1abf4fd72c1d16c4)): ?>
<?php $attributes = $__attributesOriginalef375b1d2be2fadf1abf4fd72c1d16c4; ?>
...
<?php unset($__componentOriginalef375b1d2be2fadf1abf4fd72c1d16c4); ?>
<?php endif; ?>
                <h2><?php echo e($name); ?> stories to read</h2>
            </div>
            <a href="<?php echo e(route('public.blog', ['destination' => $name])); ?>">All articles<i data-lucide="arrow-right"></i></a>
        </div>
        <div class="destination-related-grid">
            <?php $__currentLoopData = $journalPosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('public.blog.post', $post->slug)); ?>" class="destination-related-card">
                    <img src="<?php echo e(\App\Support\MediaPath::publicUrl($post->cover_image) ?: 'https://images.unsplash.com/photo-1489392191049-fc10c97e64b6?auto=format&fit=crop&w=900&q=84&fm=webp'); ?>" alt="<?php echo e($post->title); ?>" loading="lazy">
                    <small>Journal</small>
                    <strong><?php echo e($post->title); ?></strong>
                    <span><?php echo e($post->published_at?->format('M d, Y') ?: 'Travel story'); ?></span>
                </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </section>
...
<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\shishifootsteps\safari\resources\views/public/destination-section.blade.php ENDPATH**/ ?>