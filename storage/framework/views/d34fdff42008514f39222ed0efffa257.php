<?php $__env->startSection('title', 'Edit: '.$template->name); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.admin.top-bar','data' => ['title' => 'Edit: '.e($template->name).'','description' => 'Itinerary Templates','search' => false,'addButton' => false]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Edit: '.e($template->name).'','description' => 'Itinerary Templates','search' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false),'addButton' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(false)]); ?>
    <a href="<?php echo e(route('admin.itinerary-templates.show', $template)); ?>" class="button button-ghost"><i data-lucide="arrow-left"></i> Back</a>
...
<form method="POST" action="<?php echo e(route('admin.itinerary-templates.update', $template)); ?>" style="display:grid;grid-template-columns:2fr 1fr;gap:16px;align-items:start">
    ...
    <div style="display:flex;flex-direction:column;gap:16px">
        ...
        <section class="ops-panel">
            ...
            <div style="padding:16px;display:grid;grid-template-columns:1fr 1fr;gap:12px">
                <div style="grid-column:1/-1">
                    ...
                    <input type="text" name="name" value="<?php echo e(old('name', $template->name)); ?>" style="width:100%;height:38px;padding:0 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'">
                </div>
                <div style="grid-column:1/-1">
                    <label style="display:block;font-size:9px;font-weight:600;color:var(--text-muted);margin-bottom:6px">Trip Name</label>
                    <input type="text" name="trip_name" value="<?php echo e(old('trip_name', $template->trip_name)); ?>" style="width:100%;height:38px;padding:0 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'">
                </div>
                <div>
                    ...
                    <select name="destination_id" style="width:100%;height:38px;padding:0 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'">
                        ...
                        <option value="<?php echo e($country->id); ?>" <?php if(old('destination_id', $template->destination_id) == $country->id || (!old('destination_id') && $template->destination && $template->destination->country === $country->country)): echo 'selected'; endif; ?>><?php echo e($country->country); ?></option>
                ...
                <div>
                    ...
                    <input type="number" name="duration_days" id="durationDays" value="<?php echo e(old('duration_days', $template->duration_days)); ?>" min="1" max="99" style="width:100%;height:38px;padding:0 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'">
                </div>
                <div>
                    ...
                    <select name="category" style="width:100%;height:38px;padding:0 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'">
                        ...
                        <option value="<?php echo e($val); ?>" <?php if(old('category', $template->category) === $val): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div>
                    ...
                    <select name="status" style="width:100%;height:38px;padding:0 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'">
                        ...
                        <option value="<?php echo e($val); ?>" <?php if(old('status', $template->status) === $val): echo 'selected'; endif; ?>><?php echo e($label); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            </div>
        ...
        <section class="ops-panel">
            ...
            <div style="padding:16px;display:flex;flex-direction:column;gap:12px">
                <div>
                    ...
                    <textarea name="overview" rows="4" style="width:100%;padding:9px 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none;resize:vertical" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'"><?php echo e(old('overview', $template->overview)); ?></textarea>
                </div>
                <div>
                    <label style="display:block;font-size:9px;font-weight:600;color:var(--text-muted);margin-bottom:6px">Highlights</label>
                    <textarea name="highlights" rows="3" style="width:100%;padding:9px 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none;resize:vertical" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'"><?php echo e(old('highlights', $template->highlights)); ?></textarea>
                </div>
                <div>
                    <label style="display:block;font-size:9px;font-weight:600;color:var(--text-muted);margin-bottom:6px">Includes</label>
                    <textarea name="includes" rows="3" style="width:100%;padding:9px 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none;resize:vertical" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'"><?php echo e(old('includes', $template->includes)); ?></textarea>
                </div>
                <div>
                    <label style="display:block;font-size:9px;font-weight:600;color:var(--text-muted);margin-bottom:6px">Excludes</label>
                    <textarea name="excludes" rows="3" style="width:100%;padding:9px 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none;resize:vertical" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'"><?php echo e(old('excludes', $template->excludes)); ?></textarea>
                </div>
            </div>
        </section>
        ...
        <section class="ops-panel">
            ...
            <div style="padding:16px;display:flex;flex-direction:column;gap:12px">
                <div>
                    ...
                    <textarea name="terms" rows="3" style="width:100%;padding:9px 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none;resize:vertical" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'"><?php echo e(old('terms', $template->terms)); ?></textarea>
                </div>
                <div>
                    <label style="display:block;font-size:9px;font-weight:600;color:var(--text-muted);margin-bottom:6px">Booking Terms</label>
                    <textarea name="booking_terms" rows="3" style="width:100%;padding:9px 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none;resize:vertical" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'"><?php echo e(old('booking_terms', $template->booking_terms)); ?></textarea>
                </div>
                <div>
                    <label style="display:block;font-size:9px;font-weight:600;color:var(--text-muted);margin-bottom:6px">Payment Schedule</label>
                    <textarea name="payment_schedule" rows="3" style="width:100%;padding:9px 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none;resize:vertical" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'"><?php echo e(old('payment_schedule', $template->payment_schedule)); ?></textarea>
                </div>
                <div>
                    <label style="display:block;font-size:9px;font-weight:600;color:var(--text-muted);margin-bottom:6px">Cancellation Policy</label>
                    <textarea name="cancellation_policy" rows="3" style="width:100%;padding:9px 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none;resize:vertical" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'"><?php echo e(old('cancellation_policy', $template->cancellation_policy)); ?></textarea>
                </div>
                <div>
                    <label style="display:block;font-size:9px;font-weight:600;color:var(--text-muted);margin-bottom:6px">Refund Policy</label>
                    <textarea name="refund_policy" rows="3" style="width:100%;padding:9px 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none;resize:vertical" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'"><?php echo e(old('refund_policy', $template->refund_policy)); ?></textarea>
                </div>
                <div>
                    <label style="display:block;font-size:9px;font-weight:600;color:var(--text-muted);margin-bottom:6px">Important Notes</label>
                    <textarea name="important_notes" rows="3" style="width:100%;padding:9px 11px;border:1px solid #d9d0c1;border-radius:7px;font-size:9px;background:#F8F5EF;color:var(--text);outline:none;resize:vertical" onfocus="this.style.borderColor='var(--primary)'" onblur="this.style.borderColor='#d9d0c1'"><?php echo e(old('important_notes', $template->important_notes)); ?></textarea>
                </div>
            </div>
        </section>
        ...
        <section class="ops-panel">
            ...
            <div id="daysContainer" style="padding:16px;display:flex;flex-direction:column;gap:12px">
                <p style="color:var(--text-muted);font-size:9px;text-align:center;padding:16px 0" id="noDaysMsg">No days added yet.</p>
            </div>
        </section>
        ...
        <section class="ops-panel" style="position:sticky;top:96px">
            ...
            <div style="padding:16px;display:flex;flex-direction:column;gap:10px">
                <button type="submit" class="button button-primary" style="width:100%;justify-content:center">
                    <i data-lucide="save" style="width:15px;height:15px"></i> Update Template
                </button>
                <a href="<?php echo e(route('admin.itinerary-templates.show', $template)); ?>" style="display:block;text-align:center;color:var(--text-muted);font-size:9px;padding:8px 0;text-decoration:none">Cancel</a>
            </div>
        </section>
    </div>
</form>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    var dayIndex = 0;
    var existingDays = <?php echo json_encode($template->days->toArray(), 15, 512) ?>;
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Documents\xamp\htdocs\safari\resources\views\admin\itinerary-templates\edit.blade.php ENDPATH**/ ?>