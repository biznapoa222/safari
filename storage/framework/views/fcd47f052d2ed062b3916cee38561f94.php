...
<?php $__env->startSection('description', 'Find answers to common questions about luxury golf tours, safari holidays, bookings, travel planning and experiences with Shishi Footsteps.'); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.public.page-hero','data' => ['label' => 'FAQs','title' => $cms('hero_title', 'Frequently Asked Questions'),'subtitle' => $cms('hero_subtitle', 'Everything you need to know about planning your African golf safari and travel experiences.'),'image' => \App\Support\MediaPath::publicUrl($cms('hero_image'))]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['label' => 'FAQs','title' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($cms('hero_title', 'Frequently Asked Questions')),'subtitle' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($cms('hero_subtitle', 'Everything you need to know about planning your African golf safari and travel experiences.')),'image' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute(\App\Support\MediaPath::publicUrl($cms('hero_image')))]); ?>
...
<?php endif; ?>
        <h2><?php echo e($cms('editorial_title', 'Your questions, answered')); ?></h2>
    </div>
    <p><?php echo e($cms('editorial_text', 'Whether you are planning a golf tour, combining a safari with your rounds, or arranging a complete African holiday, we are here to make the process effortless. Below you will find answers to the most common questions our travellers ask.')); ?></p>
</section>
...
<section class="content-band" style="background:var(--sf-porcelain);">
    <div class="section-heading centered">
        <div>
            <?php if (isset($component)) { $__componentOriginalef375b1d2be2fadf1abf4fd72c1d16c4 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalef375b1d2be2fadf1abf4fd72c1d16c4 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.public.section-label','data' => ['label' => 'Still Have Questions?']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('public.section-label'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['label' => 'Still Have Questions?']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalef375b1d2be2fadf1abf4fd72c1d16c4)): ?>
<?php $attributes = $__attributesOriginalef375b1d2be2fadf1abf4fd72c1d16c4; ?>
...
<?php endif; ?>
    ...
    <div style="display:flex;justify-content:center;gap:16px;margin-top:32px;flex-wrap:wrap;">
        <a href="<?php echo e(route('public.contact')); ?>" class="button hero-primary">Contact Us<i data-lucide="arrow-up-right"></i></a>
        <a href="https://wa.me/254725346022?text=<?php echo e(urlencode('Hello Shishi Footsteps, I have a question about planning a golf and travel journey.')); ?>" class="button hero-secondary" target="_blank" rel="noopener">WhatsApp Us<i data-lucide="arrow-up-right"></i></a>
    </div>
</section>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.public', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\user\Documents\xamp\htdocs\safari\resources\views\public\faqs.blade.php ENDPATH**/ ?>