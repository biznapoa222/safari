...
<div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(160px,1fr));gap:10px;margin-bottom:16px">
    <div class="ops-panel" style="padding:16px">
        ...
        <p style="margin:0;font-size:18px;font-weight:700;color:var(--text)"><?php echo e($stats['total'] ?? 0); ?></p>
    </div>
    <div class="ops-panel" style="padding:16px">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px">
        ...
        <p style="margin:0;font-size:18px;font-weight:700;color:var(--text)"><?php echo e($stats['new'] ?? 0); ?></p>
    </div>
    <div class="ops-panel" style="padding:16px">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px">
        ...
        <p style="margin:0;font-size:18px;font-weight:700;color:var(--text)"><?php echo e($stats['followups_due'] ?? 0); ?></p>
    </div>
    <div class="ops-panel" style="padding:16px">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px">
        ...
        <p style="margin:0;font-size:18px;font-weight:700;color:var(--text)"><?php echo e($stats['conversion_rate'] ?? 0); ?>%</p>
    </div>
    <div class="ops-panel" style="padding:16px">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px">
        ...
        <p style="margin:0;font-size:18px;font-weight:700;color:var(--text)"><?php echo e(isset($stats['avg_value']) ? number_format($stats['avg_value'], 0) : 0); ?></p>
    </div>
</div>
<?php endif; ?>
<?php /**PATH C:\Users\user\Documents\xamp\htdocs\safari\resources\views\admin\requests\partials\_stats_cards.blade.php ENDPATH**/ ?>